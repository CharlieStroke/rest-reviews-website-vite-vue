        ...
        <div class="flex flex-col gap-4">
          <div class="flex flex-col gap-2">
            ...
            <div class="relative">
              ...
              />
              <button type="button" @click="showCurrent = !showCurrent" class="absolute right-4 top-1/2 -translate-y-1/2 text-black/30 hover:text-black/60 transition-colors focus:outline-none" :aria-label="showCurrent ? 'Ocultar' : 'Mostrar'">
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="relative">
              <input
                ...
                class="w-full bg-surface-container-lowest border border-outline-variant/15 rounded-xl px-4 py-3.5 pr-12 text-black font-sans placeholder-on-surface-variant/60 focus:outline-none focus:border-primary/50 focus:ring-4 focus:ring-primary/10 transition-all"
              />
              <button type="button" @click="showNew = !showNew" class="absolute right-4 top-1/2 -translate-y-1/2 text-black/30 hover:text-black/60 transition-colors focus:outline-none" :aria-label="showNew ? 'Ocultar' : 'Mostrar'">
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="relative">
              <input
                ...
                class="w-full bg-surface-container-lowest border border-outline-variant/15 rounded-xl px-4 py-3.5 pr-12 text-black font-sans placeholder-on-surface-variant/60 focus:outline-none focus:border-primary/50 focus:ring-4 focus:ring-primary/10 transition-all"
              />
              <button type="button" @click="showConfirm = !showConfirm" class="absolute right-4 top-1/2 -translate-y-1/2 text-black/30 hover:text-black/60 transition-colors focus:outline-none" :aria-label="showConfirm ? 'Ocultar' : 'Mostrar'">
