...
export class Establishment {
  ...
  get universityId(): string | null | undefined {
    return this.props.universityId;
  }
  get locationDetails(): string | null | undefined {
    return this.props.locationDetails;
  }
  get openingHours(): string | null | undefined {
    return this.props.openingHours;
  }
  get galleryUrls(): string[] | undefined {
    return this.props.galleryUrls;
  }
  get menuUrls(): string[] | undefined {
    return this.props.menuUrls;
  }
