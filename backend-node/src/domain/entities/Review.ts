...
export class Review {
  ...
  private static validateScore(score: number, type: string): void {
    if (score < 1 || score > 5) {
      // Assuming 1-5 scale. Update if 1-10.
  ...
  get foodScore(): number {
    return this.props.foodScore;
  }
  get serviceScore(): number {
    return this.props.serviceScore;
  }
  get priceScore(): number {
    return this.props.priceScore;
  }
  ...
  get authorCarrera(): string | undefined {
    return this.props.authorCarrera;
  }
  get establishmentName(): string | undefined {
    return this.props.establishmentName;
  }
  get sentiment(): string | undefined {
    return this.props.sentiment;
  }
  get managerReply(): string | undefined {
    return this.props.managerReply;
  }
  get managerReplyAt(): Date | undefined {
    return this.props.managerReplyAt;
  }
